...
const TokenOption: React.FC<{}> = () => {
    return (
        <div className="h-full flex flex-col bg-lime-100 devide-y divide-blue-200">
            {/* SETTING */}
            <div id="setting">
                <h1>Setting</h1>
            ...
            <div className="flex flex-col">
                <div>
                    ...
                    <input id="securityContact" placeholder="security@example.com" type="text" className="rounded-full"></input>
                </div>
                <div>
                    <label htmlFor="license">License</label>
                    <input id="license" type="text" className="rounded-full"></input>
                </div>
            </div>
        </div>
    )
